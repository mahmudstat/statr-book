...
Why use tidyverse
relation of dplyr and ggplot2 with tidyverse
...
5: Add more models and add some ml flavor.

observation
1. 2nd week: 1. Creating new variable from existing and recode, generating with condition; if else (condition from one or more than one variables)

e.g, age category


2. Mapping -> with 3/4 tidy visu
3. test to week 2
